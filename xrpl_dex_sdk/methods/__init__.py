...
# def fetch_balance(
#     self, params: models.methods.FetchBalanceParams
# ) -> models.methods.FetchBalanceResponse:
#     balances: Dict[str, models.ccxt.balances.Balance] = {}
#     info: Dict[str, Any] = {}
...
#         print(server_state_response)

#         validated_ledger = server_state_response.result.state.validated_ledger
#         xrp_reserve_base = validated_ledger
#         xrp_reserve_inc = validated_ledger

#         used_xrp = (xrp_reserve_base + account_object_count) * xrp_reserve_inc
#         free_xrp = utils.drops_to_xrp(account_info.Balance) - used_xrp
