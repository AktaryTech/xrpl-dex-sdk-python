...
#
# Request parameters for a fetch_l2_order_book call
#
# @category Parameters
#
...
#
# Expected response from a fetch_l2_order_book call
#
# @category Responses
#
FetchL2OrderBookResponse = OrderBook

__all__ = ["FetchL2OrderBookParams", "FetchL2OrderBookResponse"]
